...
const black = Color.fromARGB(255, 22, 22, 22);
...
const terms =
    ...
    '(c) Company shall mean Oxygen Tech, ABN 31968104103, email sam@o2tech.com.au, which is responsible for providing the subscription services and handling Client\'s inquiries.\n'
    ...
    '6.4.1. In the event the Section 6.5 does not apply, the Client is entitled to get a refund for the Goods from the Company only if the Client proves the Goods to be not as described or faulty. In such cases, Client must contact our customer support at sam@o2tech.com.au within 14 days of purchase and provide detailed information proving Company\'s Goods fault (with visual proof attached).\n'
    ...
    '6.5.1. The Client has notified the Company about their decision to return the Goods within 30 days from the delivery of relevant Goods at sam@o2tech.com.au and before returning the Goods.\n'
    ...
    '16.3. The Client may request a copy of these T&Cs or any other contractual document by contacting sam@o2tech.com.au.\n\n'
    ...
    '16.5. The Client may contact us at any time by sending a message to sam@o2tech.com.au.\n\n'
    '17. Complaints\n\n'
    '17.1. Any complaints in relation to the Company and the Goods or Services provided to the Client, or in relation to subscriptions should be addressed to Oxygen Tech by contacting sam@o2tech.com.au.\n\n'
...
const jamesTestimonial =
    '"Sam was thorough, his communication was exemplary and he walked us through '
    'the website process and jargon that was completely foreign to us. We would '
    'highly recommend working with Sam to get your organisation a website. '
    'He was able to link our website with our client/public portal for quoting '
    'and applications. His post-website help and amendment process is next '
    'level and really quick. 5 Stars is an understatement."';
